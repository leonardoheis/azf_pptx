...
from config import STORAGE_CONN_STRING, TABLE_NAME, THREAD_TIMEOUT_MINUTES
from company_research1 import fill_company_research1
from company_research2 import fill_company_research2
from company_research3 import fill_company_research3
from industry_research import fill_industry_research
...
def agent_httptrigger(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        return func.HttpResponse(
            json.dumps({
                "status": "success",
                "message": "Successfully processed 4 JSON files from Power Automate",
                "data": processed_data,
                "files_received": {
